...
class Api {
  ...
  static Future<Map<String, dynamic>> username(String name) =>
      _get("/username/$name");

  static Future<Map<String, dynamic>> domain(String dom) =>
      _get("/domain/$dom");

  static Future<Map<String, dynamic>> url(String url) =>
      _get("/url?url=${Uri.encodeComponent(url)}");

  static Future<Map<String, dynamic>> phone(String num) =>
      _get("/phone/$num");

  static Future<Map<String, dynamic>> ip(String addr) =>
      _get("/ip/$addr");
