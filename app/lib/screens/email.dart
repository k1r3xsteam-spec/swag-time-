...
class EmailScreen extends StatefulWidget {
  ...
  @override
  State<EmailScreen> createState() => _S();
}

class _S extends State<EmailScreen> {
  ...
  Future<void> run() async {
    ...
    try {
      res = await Api.email(c.text.trim());
    } catch (e) {
        ...
        child: Column(
          children: [
            TextField(
              ...
              decoration: const InputDecoration(labelText: "> введи email"),
            ),
