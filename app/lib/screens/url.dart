...
class UrlScreen extends StatefulWidget {
  ...
  @override
  State<UrlScreen> createState() => _S();
}

class _S extends State<UrlScreen> {
        ...
        child: Column(
          children: [
            TextField(
              ...
              decoration: const InputDecoration(labelText: "> введи url"),
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text(loading ? "[*] scanning..." : "[ RUN ]"),
              ),
            ),
